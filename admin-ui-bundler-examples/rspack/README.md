# io.Manager Admin UI - Rspack Example

This example demonstrates how to bundle the **io.Manager Admin UI** (`@interopio/manager-admin-ui`) as a standalone React single-page application using **Rspack** - a fast, Rust-based bundler with a Webpack-compatible configuration API.
